...
path(path, 'model_routines\field');
...
a_1 = a;
a_2 = a;
% Note S_factors_fast only applies for the cylindrical shape geometry, it
% must be adapted for other geometries. 
...
write_attempts = 1; % write attempts on target island
